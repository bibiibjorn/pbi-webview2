 ...
 * over CDP, encoding verified tag-then-act recipes as first-class tools.
 *
...
const server = new McpServer(
  { name: 'pbi-webview2', version: '1.2.0' },
  {
    instructions:
      ...
      'Tools connect lazily and return {connected:false,...} when Desktop is unreachable. ' +
      'Never save the report after test clicks; restore slicers/page when done.',
  }
);
